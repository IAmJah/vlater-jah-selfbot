...
```
    """)
  emHelp.set_author(name = "vlaterutlis - Help", icon_url = client.user.avatar_url, url = "https://github.com/IAmJah")
  emHelp.set_footer(text = "Made by vlater || https://github.com/IAmJah")
  try:
